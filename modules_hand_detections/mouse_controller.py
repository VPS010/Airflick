...
class MouseController:
    ...
    def move_mouse_relative(self, x, y):
        ...
        Implements a mouse-like relative movement approach
        """
        ...
        delta_x = (x - self.prev_x) * self.scaling_factor * self.screen_width
        delta_y = (y - self.prev_y) * self.scaling_factor * self.screen_height
